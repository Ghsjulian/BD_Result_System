...
if ($requestMethod == "POST") {
  ...
  if ($group == "Science") {
    $sql = "INSERT INTO `science`(`student_name`, `roll`, `bangla`, `english`, `physics`, `chemistry`, `bd_history`, `ict`, `mathematics`, `higher_math`, `agreeculture`, `biology`,`islam_education`, `hindu_education`, `christian_education`, `physical_education`, `career_education`, `history`)VALUES('$name','$roll','$bangla','$english','$physics','$chemistry','$bangladesh_history','$ict','$math','','$agriculture','$biology','$islam','$hindu','$christian','$phisical','$carrier','')";
    ...
    *
    */
    $sql = "INSERT INTO `humanity`(`student_name`, `sub_code`, `bangla`, `english`, `math`, `geography`, `civic_citizen`, `economics`, `general_science`, `ict`, `history`,
    `agriculture`, `hindu`, `christian`, `islam`) VALUES
    ('$name','','$bangla','$english','$math','$geography','','[value-8]','[value-9]','[value-10]','[value-11]','[value-12]','[value-13]','[value-14]','[value-15]','[value-16]')";
